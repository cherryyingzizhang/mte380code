...
// describing Remote IR codes 
{
  ...
  case 0xFF02FD: //play/pause
    ...
    break;
  case 0xFF629D: //VOL+
    Serial.println("LatestYaw: " + String(latestYaw));
    break;
  case 0xFFA857: //VOL-
...
/////////////////////////////////////////////////////////////////////////////////////////////////
//Translate Serial from Processing Language
/////////////////////////////////////////////////////////////////////////////////////////////////
void translateSerial(char command) {
  switch(command) {
    case 'f': //forward
      Forward();
    break;
    ...
    case 'u': //up
      Up();
    break;
    case 'n': //left in place
      LeftInPlace();
    break;
    case 'd': //down
      Down();
    break;
    case 'm': //right in place
      RightInPlace();
    break;
    case 'j': //stop lateral
      StopLat();
    ...
    break;
    case 'p':
      Serial.println("LatestPressureDepth: " + String(latestPressureDepth));
    break;
    case 'a':
      startAutonomous();
    break;
...
void RightInPlace() {
  Serial.println("Right In-Plwwace");
  Motors[2].Motor.writeMicroseconds(ESCSettings.MediumSpeed + change *2); //left
...
void LeftInPlace() {
  ...
  Motors[2].Motor.writeMicroseconds(ESCSettings.MediumSpeed - change - 40); //left
  Motors[3].Motor.writeMicroseconds(ESCSettings.MediumSpeed - change * 2); //right
}
...
void startAutonomous() {
  ...
  while(millis() - t < (22.5/upSpeed*1000) && (latestPressureDepth - (10) + 3) > 0) { //140-30.5*2.54
